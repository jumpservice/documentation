---
description: Learn how to Integrate OAuth2 authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Integrate OAuth2 authentication <Icon name="xpack"/>
