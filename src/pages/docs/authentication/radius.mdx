---
description: Learn how to Integrate RADIUS authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---
...
<div>
Optionally, in the **OTP in RADIUS** field, check to enable RADIUS as the MFA backend. For more information, see [Enable RADIUS MFA backend](/docs/authentication/radius#enable-radius-mfa-backend).
</div>
...
<Steps>
<div>
Configure RADIUS authentication by following the [Integrate RADIUS authentication](/docs/authentication/radius#how-to-configure) guide.
</div>
