---
description: Learn how to Integrate SAML2 authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Integrate SAML2 authentication <Icon name="xpack"/>
