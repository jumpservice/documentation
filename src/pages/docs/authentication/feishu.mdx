---
description: Learn how to Integrate FeiShu authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Integrate FeiShu authentication <Icon name="xpack"/>
