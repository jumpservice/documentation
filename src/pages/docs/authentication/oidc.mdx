---
description: Learn how to Integrate OIDC authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Integrate OIDC authentication <Icon name="xpack"/>
