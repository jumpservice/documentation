---
description: Learn how to Integrate AD/LDAP HA authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Integrate AD/LDAP HA authentication <Icon name="xpack"/>
...
<Alert type="tip">
Configure LDAP before setting up LDAP HA. See [Integrate LDAP guide](/docs/authentication/ldap)
</Alert>
