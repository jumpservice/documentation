---
description: Learn how to Integrate Passkey authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---
...
<div>
Navigate to the **System settings > Authentication > Passkey**.
</div>
