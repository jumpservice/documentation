---
description: Learn how to Integrate Lark authentication in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Integrate Lark authentication <Icon name="xpack"/>
