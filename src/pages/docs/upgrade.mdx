...
```sh
wget https://github.com/jumpserver/installer/releases/download/v4.8.0/jumpserver-installer-v4.8.0.tar.gz
```
</div>
...
```sh
tar -xf jumpserver-installer-v4.8.0.tar.gz
```
</div>
...
```sh
cd jumpserver-installer-v4.8.0
```
</div>
