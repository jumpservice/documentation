...
>
  ...
  <Tab titleKey="wget">
    <Steps stepLevel="2">
      ...
      ```sh
      cd /opt && wget -O jumpserver-ee-v5.0.0-x86_64.tar.gz "https://support.fit2cloud.com/download/00000000-0000-0000-0000-00000000000/jumpserver-ee-v5.0.0-x86_64.tar.gz"
      ```
      </div>
    </Steps>
  </Tab>
...
Extract the installation package.
```sh 
tar -zxvf jumpserver-ee-v5.0.0-x86_64.tar.gz
```
</div>
...
Change to the extracted directory.
```sh
cd jumpserver-ee-v5.0.0-x86_64
```
</div>
