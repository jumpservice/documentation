...
When an administrator views an asset account’s secret, the system requires MFA verification by default. This setting controls the validity period of the verification, with a default value of 60 seconds. Within this period, subsequent secret views do not require repeated MFA verification.
