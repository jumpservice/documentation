---
description: Learn how to Authentication security in JumpServer documentation, with key steps, configuration options, and best practices.
---
...
<div>
On the right page, click **Auth security** tab.
</div>
</Steps>
