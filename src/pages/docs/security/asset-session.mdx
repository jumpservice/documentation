---
description: Learn how to Asset session in JumpServer documentation, with key steps, configuration options, and best practices.
---
...
### Configure watermark content <Icon name="xpack" />
#### Session content
