...
<Icon name="xpack" /> Enterprise only.

Organization roles define a user’s position within the current organization and grant only the permissions assigned to each role. Multiple organization roles can be assigned, with permissions combined.
