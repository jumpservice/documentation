...
Only appears when creating a user.

<dl>
<dt>Reset link will be generated and sent to the user</dt>

<dd>
Selecting this option will trigger the system to send a password setup email to the user. The user can log in after following the instructions to reset their password.
</dd>
