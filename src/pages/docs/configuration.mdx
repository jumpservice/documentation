---
description: Learn how to Configuration in JumpServer documentation, with key steps, configuration options, and best practices.
---
...
### FACE_RECOGNITION_ENABLED <Icon name="xpack" />
`enterprise`
...
### VAULT_HCP_HOST <Icon name="xpack" />
`enterprise`
...
### VAULT_HCP_TOKEN <Icon name="xpack" />
`enterprise`
...
### VAULT_HCP_MOUNT_POINT <Icon name="xpack" />
`enterprise`
...
### VAULT_AZURE_HOST <Icon name="xpack" />
`enterprise`
...
### VAULT_AZURE_CLIENT_ID <Icon name="xpack" />
`enterprise`
...
### VAULT_AZURE_CLIENT_SECRET <Icon name="xpack" />
`enterprise`
...
### VAULT_AZURE_TENANT_ID <Icon name="xpack" />
`enterprise`
...
### VAULT_AWS_REGION_NAME <Icon name="xpack" />
`enterprise`
...
### VAULT_AWS_ACCESS_KEY_ID <Icon name="xpack" />
`enterprise`
...
### VAULT_AWS_ACCESS_SECRET_KEY <Icon name="xpack" />
`enterprise`
