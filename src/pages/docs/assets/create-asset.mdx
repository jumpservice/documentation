...
2. In the **Select Provider** popup, choose an asset platform (e.g., Cisco).
...
5. In the **Platform** field, select the platform of the asset. The default is the platform selected in **Step 2**, but you can change it to another platform of the same type (e.g., H3C).
