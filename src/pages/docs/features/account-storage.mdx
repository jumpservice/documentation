---
description: Learn how to Account storage in JumpServer documentation, with key steps, configuration options, and best practices.
---

# Account storage <Icon name="xpack-lg" />

<EnterpriseFeatureCta
  feature="External account storage"
  description="Integrate with HashiCorp Vault, Azure Key Vault, or AWS Secrets Manager to store asset credentials outside JumpServer."
/>
