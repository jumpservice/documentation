...
<div>
In the **Use keycloak** field, check the box to use the Keycloak configuration. The following fields are required:
...
<div>
In the **Use keycloak** field, clear the box to use the native OIDC configuration. The following fields are required:
