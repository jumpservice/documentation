...
<HorizontalTable 
  headers={['Request Method', 'Describes']} 
  rows={[
...
<div>
In the **Use keycloak** field, check the box to use the Keycloak configuration, or clear the box to use the native OIDC configuration.
  <Tabs
    titlesMap={{
