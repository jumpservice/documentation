...
<Alert type="note">
Configure LDAP before setting up LDAP HA. See [Integrate LDAP auth](/docs/system-settings/authentication/ldap.mdx)
</Alert>
...
<div>
In the **LDAP HA** field, enable or disable the LDAP HA authentication.
</div>
