...
<img src="/images/docs/admin-guides/system-settings/email-suffix.png" alt="image" width="450"/>
4. Click **Submit**.
...
<img src="/images/docs/admin-guides/system-settings/login-page-forgot-password.png" alt="image" width="350"/>

1. In the upper-right corner of any page in JumpServer, click <img src="/images/docs/svg/nav-setting.svg" alt="x" width="15" style={{ display: "inline-block" }}/>.
<img src="/images/docs/admin-guides/system-settings/nav-settings.png" alt="image" width="450"/>
2. Navigate to **System settings > Authentication > Basic**.
3. In the **Forgot password URL** field, enter the URL for the forgot password link.
<img src="/images/docs/admin-guides/system-settings/forgot-password-url.png" alt="image" width="450"/>
4. Click **Submit**.
...
<img src="/images/docs/admin-guides/system-settings/redirecting.png" alt="image" width="450"/>
...
<img src="/images/docs/admin-guides/system-settings/login-redirection.png" alt="image" width="450"/>
4. Click **Submit**.
