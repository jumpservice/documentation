...
1. In JumpServer, navigate to **System settings > Authentication > Basic**.
2. In the **Email suffix** field, enter the email suffix (such as `example.com`).
3. Click **Submit**.
...
1. In JumpServer, navigate to **System settings > Authentication > Basic**.
2. In the **Forgot password URL** field, enter the URL for the forgot password link.
3. Click **Submit**.
...
1. In JumpServer, navigate to **System settings > Authentication > Basic**.
2. In the **Login redirection** field, enable or disable the user login redirection.
3. Click **Submit**.
