---
description: Learn how to Message template in JumpServer documentation, with key steps, configuration options, and best practices.
---
...
Below the field, click "<Icon name="QuestionMark" />Help" to view the available variables for the selected template.
</div>
