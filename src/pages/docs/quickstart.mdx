...
<div>
Navigate to **Console > Assets > Host**, and click **Create** button.
</div>

<div>
On the right-side page, select the **Linux** platform and go to the asset creation page.
</div>
...
In the **Accounts** field, click the **Add** button to add an account.
    ...
    <div>
    Other account fields keep the default values, and click **Confirm**.
    </div>
    </Steps>
</div>

<div>
Other asset fields keep the default values, and click **Submit**.
</div>

</Steps>

## Authorizing asset for user
