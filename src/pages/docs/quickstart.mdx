...
JumpServer is an open-source PAM tool (Bastion Host) that offers efficient and secure asset management and operation auditing capabilities.

This guide covers quick installation and deployment of JumpServer, as well as basic operations such as creating users, assets, and authorizations, logging in as a user and connecting to assets, auditing sessions and login logs.


## Prerequisites

Before starting, please install JumpServer. For more information, see [JumpServer Installation Guide](/docs/installation).


## Log in as Administrator

You have successfully installed JumpServer. 

Now, please open your Google Chrome browser and log in as an Administrator.


You can now access the JumpServer service using your web browser by navigating to `http://your-jumpserver-ip/`. For the best experience, we recommend using Google Chrome.
