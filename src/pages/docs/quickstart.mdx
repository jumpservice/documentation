...
<div>
An asset connection pop-up will appear, you can follow the guide to connect the asset.
...
<Alert>
Click the <Icon name="chevron-down"/> at the end of the row to view the command result.
</Alert>
</div>
