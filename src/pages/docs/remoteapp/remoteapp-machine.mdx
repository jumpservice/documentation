...
By default, the system uses ssh. To use winrm, see [Use WinRM for RemoteApp machine](#use-winrm-for-remoteapp-machine-).
...
## Use WinRM for RemoteApp machine <Icon name="xpack" />
<Steps>
<div>
Create a RemoteApp machine and select "winrm" and "rdp" protocols. For more information, see [Create a RemoteApp machine](#create-a-remoteapp-machine).
</div>
...
<Steps stepLevel="2">
  <div>
  In the left menu, click **<Icon name="Platform" /> Platform**.
  </div>
