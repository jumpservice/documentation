---
description: Learn how to VirtualApp in JumpServer documentation, with key steps, configuration options, and best practices.
---

# VirtualApp <Icon name="xpack-lg"/>

<EnterpriseFeatureCta
  feature="VirtualApp containers"
  description="Connect to assets through on-demand VirtualApp containers managed by the Panda application provider component."
/>
...
For details on how to enable the VirtualApp feature, see [Enable virtual app](/docs/features/virtual-app#enable-virtual-app).

### 2. Configure PANDA_HOST_IP
<Steps>
