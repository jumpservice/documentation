...
After completing the installation, access JumpServer in your browser at: <br/>
```sh
...
<Steps>
### Set repository
Set up the JumpServer Helm repository.
```sh
helm repo add jumpserver https://jumpserver.github.io/helm-charts
```

### Edit file
Edit the `values.yaml` file for JumpServer.
<details>
